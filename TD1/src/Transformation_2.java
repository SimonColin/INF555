...
public class Transformation_2 {
	...
	public Transformation_2(double theta, Point_2 center) {
		Vector_2 v1 = new Vector_2(center.getX(), center.getY());
		Transformation_2 t1 = new Transformation_2(v1);
		Transformation_2 t2 = new Transformation_2(theta);
		Vector_2 v2 = new Vector_2(-center.getX(), -center.getY());
		Transformation_2 t3 = new Transformation_2(v2);
		Transformation_2 T = t1.compose(t2.compose(t3));
		this.m = T.m;
		//throw new Error("to be completed: TD1");
	}
